...
Trzyma konfigurację (`caelo_mcp.json`, atomowo + `load_json_or_backup`) i **runtime**
...
wracają do renderera (`public_config` maskuje). Plik `caelo_mcp.json` jest gitignored.
"""
