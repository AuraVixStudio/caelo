...
Uruchamia ``python -m grok_core`` z ustawionym GROK_CORE_TOKEN, czeka na linię
...
Użycie:  <python> grok_core/tools/handshake_check.py
...
PKG_DIR = os.path.dirname(THIS_DIR)          # .../grok_core
