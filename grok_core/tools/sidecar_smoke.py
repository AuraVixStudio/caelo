"""Smoke-test SPAKOWANEGO sidecara (dist\\grok-core\\grok-core.exe).

Uruchamia zbudowany przez PyInstallera .exe dokładnie tak, jak robi to Electron
(env GROK_CORE_TOKEN + odczyt handshake'u na stdout) i sprawdza, że frozen bundle
...
Użycie:
    python grok_core/tools/sidecar_smoke.py [ścieżka\\do\\grok-core.exe]
"""
...
DEFAULT_EXE = os.path.join(REPO_DIR, "dist", "grok-core", "grok-core.exe")
