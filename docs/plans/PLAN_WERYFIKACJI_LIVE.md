...
| H | Funkcje-widma (decyzja) | P3 | 🟡 | 2026-06-19 | **H1 (embeddingi) ⛔ FAILED — xAI 404 na `/v1/embeddings`** (jak vector stores) → **B8/pamięć (H1+H2) ODŁOŻONE** (uśpione+udokumentowane, bez torch). **H4 web_fetch ✅** (https-only+SSRF+allowlista, opt-in). Zostają H5 (git worktree), H6 (auto-compact); H3 sandbox = Linux/mac only. |
