...
- [ ] **F — Subagenci / zespoły** P2 🟡 — **F1+F2 ✅ 2026-06-18** (F1: delegacja end-to-end, 3 subagenci
  równolegle, kontekst rodzica czysty, głębia 1; F2: review-modal + merge→workspace + checkpoint cofalny +
  wykrycie konfliktu; po drodze naprawione 3 bugi UX: review-modal, zwijanie panelu, `shrink-0`/scroll).
  Zostają: F3 cascade stop (tree-kill), F4 skille-orkiestratory (implement/review/design/best-of-n).
