...
| [`plans/ANALIZA_PROGRAMU_2026-06-10.md`](plans/ANALIZA_PROGRAMU_2026-06-10.md) | **Gruntowny przegląd programu (2026-06-10)** — rewizja wieloagentowa 5 obszarów + testy: 10 znalezisk P1 (m.in. traversal `sid` sesji, deny-bypass grep/glob, LSP short-reads, 82 MB data-URI w `GET /genjobs`, brak izolacji `DATA_DIR` w smoke), katalog P2/P3, udoskonalenia, **porównanie z konkurencją (TOP-10 funkcji)** i rekomendowana kolejność działań. Kandydat na rundę napraw #4. | 📋 analiza |
